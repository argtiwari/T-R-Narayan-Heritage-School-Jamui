    ...
    features: [
      {
        ...
        benefit:
          "A structured academic foundation for confident learning.",
        icon: BookOpen,
        tone: "gold",
        image: "/images/discovery/smart-class.jpg",
      },

      {
        title: "ENGLISH MEDIUM",
        benefit:
          "Communication that grows with every learning experience.",
        icon: BookOpen,
        tone: "olive",
        image: "/images/discovery/smart-class.jpg",
      },

      {
        ...
        benefit:
          "Comfortable environments designed for meaningful learning.",
        icon: Monitor,
        tone: "blue",
        image: "/images/discovery/smart-class.jpg",
      },
    ...
    features: [
      {
        title: "SMART CLASSES",
        benefit:
          "Technology-supported classroom learning.",
        icon: Monitor,
        tone: "gold",
        image: "/images/discovery/smart-class.jpg",
      },

      {
        ...
        benefit:
          "Learning experiences supported by digital tools.",
        icon: Monitor,
        tone: "blue",
        image: "/images/discovery/smart-class.jpg",
      },
...

  {
    ...
    features: [
...

      {
        title: "LIBRARY",
        benefit:
          "A space for reading and independent learning.",
        icon: BookOpen,
        tone: "gold",
        image: "/images/discovery/smart-class.jpg",
      },
...

  {
    ...
    features: [
...

      {
        title: "MUSIC & DANCE",
        benefit:
          "Creative expression and joyful learning.",
        icon: Trophy,
        tone: "olive",
        image: "/images/discovery/smart-class.jpg",
      },

      {
        ...
        benefit:
          "Opportunities to participate, create and grow.",
        icon: HeartHandshake,
        tone: "blue",
        image: "/images/discovery/smart-class.jpg",
      },
    ...
    features: [
      {
        title: "HOSTEL",
        benefit:
          "A supportive environment beyond school hours.",
        icon: HeartHandshake,
        tone: "olive",
        image: "/images/discovery/smart-class.jpg",
      },
...

      {
        ...
        benefit:
          "Care throughout the student journey.",
        icon: HeartHandshake,
        tone: "gold",
        image: "/images/discovery/smart-class.jpg",
      },
...

  {
    ...
    features: [
...

      {
        title: "SECURE ENTRY",
        benefit:
          "Thoughtful access and arrival systems.",
        icon: ShieldCheck,
        tone: "gold",
        image: "/images/discovery/smart-class.jpg",
      },
